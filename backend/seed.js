...
async function seed() {
  ...
  const opPassword    = await bcrypt.hash('admin123', 10)

  await User.create([
    { name: 'Bhavya Gulati', phone: '+919311796190', password: adminPassword,  role: 'admin'    },
    { name: 'Sanjay Kumar',   phone: '+919999999998', password: opPassword,     role: 'operator' },
  ])
  ...
  // const [, , seller1] = await Lead.create([
  //   {
  //     name:             'Rajesh Kumar',
  //     phone:            '+919811045231',
  //     leadType:         'buyer',
  ...
  //     interactionHistory: [
  //       { note: 'Referred by an agent. Looking for full floor in Block A. Has ready money.', stage: 'new', createdAt: new Date(Date.now() - 2 * 86400000) },
  //     ],
  //   },
  //   {
  //     name:             'Mohit Agarwal',
